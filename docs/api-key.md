...
Hvis `OGC_API_KEY` ikke er satt (tom streng eller mangler), er alle endepunkter åpne.
...
curl -H 'X-API-Key: din-nøkkel-her' \
  https://api.kartverket.no/smia-ogc-api/v1/collections/bopliktomraade/items
```
